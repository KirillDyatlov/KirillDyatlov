...
<br>Мне 18 лет, я родился 19 ноября 2007 года. В 2023 году закончил школу и поступил в колледж при ВГТУ, сейчас учусь на 3 курсе, окончу учебу в 2027.
...
<br>В январе 2026 года я также зайнялся разработкой мобильных приложений. Пишу я их на Java, т.к. она мне нравится гораздо больше, чем Kotlin. Да, я очень странный тип.
<br>30 января от меня вышло первое приложение - iDay. Это сборник мини-сервисов, которые можно как бы использовать в одном месте. Оно идет на абсолютно любом телефоне с Android 8.0. Оно пока имеет некоторые косяки, но исправлять я их буду не раньше конца февраля, т.к. сейчас (по состоянию на 30.01.2026 01:23) является более углубленное изучение джавы, андроид разработки и еще некоторых аспектов плюсов
...
<ul>
  ...
  <li>📱Мобильные приложения пишу на Java</li>
